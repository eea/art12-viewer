...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "speciescode", sa.String(length=10), server_default="", nullable=False
        ),
        ...
        sa.Column(
            "br_range_surface_area_downrounded", sa.String(length=35), nullable=True
        ),
        ...
        sa.Column(
            "conclusion_status_level1_record", sa.String(length=1), nullable=True
        ),
        sa.Column("conclusion_status_level1", sa.String(length=512), nullable=True),
        sa.Column(
            "conclusion_status_level2_record", sa.String(length=1), nullable=True
        ),
        sa.Column("conclusion_status_level2", sa.String(length=512), nullable=True),
        sa.Column(
            "conclusion_population_size_unit", sa.String(length=10), nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "conclusion_population_trend_long", sa.String(length=25), nullable=True
        ),
