...
def upgrade():
    ...
    op.add_column(
        "etc_birds_eu_view",
        sa.Column("br_conclusion_status_label", sa.String(length=255), nullable=True),
    )
    op.add_column(
        "etc_birds_eu_view",
        sa.Column("br_contribution_target1", sa.String(length=50), nullable=True),
    )
    op.add_column(
        "etc_birds_eu_view",
        sa.Column("br_red_list_cat", sa.String(length=255), nullable=True),
    )
    op.add_column(
        "etc_birds_eu_view",
        sa.Column("wi_conclusion_status_label", sa.String(length=255), nullable=True),
    )
    op.add_column(
        "etc_birds_eu_view",
        sa.Column("wi_contribution_target1", sa.String(length=50), nullable=True),
    )
    op.add_column(
        "etc_birds_eu_view",
        sa.Column("wi_red_list_cat", sa.String(length=255), nullable=True),
    )
    op.add_column(
        "etc_birds_eu_view",
        sa.Column("red_list_cat_prev", sa.String(length=255), nullable=True),
    )
