...
class TemplateView(MethodView):
    ...
    def get(self):
        return render_template(self.template_name, **self.get_context_data())
...
def range_trend(
    range_trend_bs, range_trend_magnitude_min_bs, range_trend_magnitude_max_bs
):
