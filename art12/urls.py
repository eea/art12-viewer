...
# Factsheet views
views.add_url_rule('/factsheet/', view_func=BirdFactsheet.as_view('factsheet'))
views.add_url_rule('/factsheet/header/',
                   view_func=FactsheetHeader.as_view('factsheet-header'))
views.add_url_rule('/factsheet/footer/',
