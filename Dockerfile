...
RUN runDeps="curl vim build-essential netcat mysql-client default-libmysqlclient-dev python-dev libldap2-dev libsasl2-dev libssl-dev libxrender1 libfontconfig1 libxext6" \
	&& apt-get update \
