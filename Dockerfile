...
RUN runDeps="curl gcc vim build-essential netcat-traditional python3-dev libldap2-dev libsasl2-dev libldap-common libssl-dev libxrender1 libfontconfig1 libxext6 wkhtmltopdf" \
	&& apt-get update \
