...
def users():
    ...
    # dataset = auth.models.Dataset.query.order_by(
    #     auth.models.Dataset.id.desc()
    # ).first()
    # countries = (
...
def admin_user(user_id):
    ...
    all_roles = (
        auth.models.Role.query.with_entities(
            auth.models.Role.name, auth.models.Role.description
        )
